...
```bash
npx wrangler secret put ADMIN_USER      # usuario del panel (ej: admin)
npx wrangler secret put ADMIN_PASS      # clave del panel (¡elegí una segura!)
npx wrangler secret put AUTH_SECRET     # clave aleatoria, ej: openssl rand -hex 32
```
